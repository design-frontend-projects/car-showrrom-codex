...
## Purpose
Define the password reset OTP contract, including generic reset requests, hashed OTP verification, reset completion, and auditability without exposing reset secrets.
