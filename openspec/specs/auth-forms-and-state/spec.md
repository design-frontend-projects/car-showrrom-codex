# auth-forms-and-state Specification

## Purpose
Define the Angular auth form, API-client, Signal Store, route protection, and shell account-control contract for cookie-backed SSR authentication.
