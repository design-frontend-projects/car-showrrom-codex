# client-profile-page Specification

## Purpose
Define the authenticated client profile page contract, including route protection, sanitized current-user data display, page states, and links to existing account workflows.
